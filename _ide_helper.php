...
')
     ...
     */ 
        ...
        public static function guard($name = null)
        {
                        /** @var \Lauthz\EnforcerManager $instance */
                        return $instance->guard($name);
        }
                    /**
        ...
        {
                        /** @var \Lauthz\EnforcerManager $instance */
                        return $instance->getDefaultGuard();
        }
                    /**
         * Set the default guard driver the factory should serve.
         *
         ...
         * @static 
         */ 
        public static function setDefaultGuard($name)
        {
                        /** @var \Lauthz\EnforcerManager $instance */
                        return $instance->setDefaultGuard($name);
        }
...
namespace  { 
            ...
            class Enforcer extends \Lauthz\Facades\Enforcer {}
